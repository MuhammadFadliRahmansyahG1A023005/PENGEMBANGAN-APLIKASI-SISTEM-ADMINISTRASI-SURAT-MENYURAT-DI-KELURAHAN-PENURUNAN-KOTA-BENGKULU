...
<body>
    ...
    <div class="glass-card">
        ...
        <h3 class="text-center fw-bold mb-1">Lupa Password</h3>
        ...
        @if (session('success'))
            <div class="alert alert-success" style="background: rgba(40, 167, 69, 0.2); border: 1px solid rgba(40, 167, 69, 0.5); color: #fff;">
                {{ session('success') }}
            </div>
        @endif
        ...
        <form action="{{ route('password.email') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" class="form-control border-start-0" placeholder="Masukkan email..." required>
                </div>
            </div>
